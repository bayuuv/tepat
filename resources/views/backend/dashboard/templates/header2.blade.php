...
<html lang="en">
  <head>
    ...
    <!-- <script src="{{asset('assets/ckfinder/ck.js')}}"></script> -->
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
          <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo" href="#"><h2>{{Session::get('judul')}}</h2></a>
            <a class="navbar-brand brand-logo-mini" href="#"><img src="{{ url('public/uploaded_files/web-profile/')}}/{{Session::get('logo')}}"></img></a>
          </div>
