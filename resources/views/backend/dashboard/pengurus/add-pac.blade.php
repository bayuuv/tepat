    ...
    <div class="content-wrapper">
      <div class="page-header">
        <h3 class="page-title">
          ...
          Tambah Pengurus Korcam
        </h3>
        <nav aria-label="breadcrumb">
          <ul class="breadcrumb">
              <a href="{{url('pengurus/pac')}}">Korcam</a>&nbsp;/&nbsp;Tambah Pengurus Korcam baru
          </ul>
        </nav>
      </div>
          ...
          <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description"> Tambah Pengurus Korcam baru </p>
                  <form action="{{url('pengurus/pac/store')}}" class="forms-sample" method="POST">
                      {{ csrf_field() }}
                    <div class="row">
                      <div class="col">
                      <div class="form-group">
                          <label for="nama_dpc">Nama Korcam</label>&nbsp<label style="color:red;">{{$errors->first('nama_dpc')}}</label>
                          <select id="nama_dpc" class="form-control selectpicker anggota dynamic" name="nama_pac" data-live-search="true" data-dependent="no_anggota">
                        ...
                        <div class="form-group">
                          <label for="nama_anggota">Nama</label>&nbsp<label style="color:red;">{{$errors->first('nama_anggota')}}</label>
                          <input type="text" class="form-control" id="nama_anggota" name="nama_anggota" placeholder="Nama Anggota" value="{{ old('nama_anggota') }}" disabled>
                        </div>
                        <div class="form-group">
