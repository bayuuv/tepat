    ...
    <div class="content-wrapper">
      <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
          <ul class="breadcrumb">
              <a href="{{url('dpp')}}">Pengurus Pusat</a>&nbsp;/&nbsp;Tambah Pengurus Pusat baru
          </ul>
        </nav>
      </div>
          ...
          <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="{{url('dpp/store')}}" class="forms-sample" method="POST">
                      {{ csrf_field() }}
                    <div class="row">
                      <div class="col">
                        <div class="form-group">
                          <label for="exampleInputName1">Nama Pengurus Pusat</label>&nbsp<label style="color:red;">{{$errors->first('nama')}}</label>
                          <input type="text" class="form-control" id="exampleInputName1" name="nama" placeholder="Nama Pengurus Pusat" value="{{ old('nama') }}">
                        </div>
                        <div class="form-group">
