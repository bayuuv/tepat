    ...
    <div class="content-wrapper">
      <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
          <ul class="breadcrumb">
              <a href="{{url('dpc')}}">Korwil</a>&nbsp;/&nbsp;Tambah Korwil baru
          </ul>
        </nav>
      </div>
          ...
          <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description"> Tambah Korwil baru </p>
                  <form action="{{url('dpc/store')}}" class="forms-sample" method="POST">
                      {{ csrf_field() }}
                    <div class="row">
                      <div class="col">
                        <div class="form-group">
                          <label for="exampleInputName1">Nama Korwil</label>&nbsp<label style="color:red;">{{$errors->first('nama')}}</label>
                          <input type="text" class="form-control" id="exampleInputName1" name="nama" placeholder="Nama Korwil" value="{{ old('nama') }}">
                        </div>
                        <div class="form-group">
