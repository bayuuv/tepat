          ...
          <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="{{url('setting-pages/berita/update')}}" class="forms-sample" method="POST" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      ...
                      <div class="col">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-xs-12">
                              <input type="text" class="form-control file-upload-info" name="img_cover" placeholder="Unggah cover" value="{{ $item['gambar'] }}">
                        ...
                        <div class="form-group">
                          <label for="konten">Konten</label>&nbsp<label style="color:red;">{{$errors->first('konten')}}</label>
